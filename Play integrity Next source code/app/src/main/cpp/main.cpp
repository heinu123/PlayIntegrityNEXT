...
#define JSON_FILE "/data/adb/pif.json"
...
static void companion(int fd) {
    ...
    system("/data/adb/modules/playintegrityfix/curl -o /data/adb/pif.json https://raw.githubusercontent.com/daboynb/autojson/main/pif.json");
